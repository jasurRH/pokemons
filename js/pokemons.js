...
for(array of pokemons){
	...
	elId.textContent = `${array.id}`;
	elNum.textContent = `${array.num}`;
	elName.textContent = `${array.name}`;
	elImg.src = `${array.img}`;
	elType.textContent = `${array.type}`;
	elHeight.textContent = `${array.height}`;
	elWeight.textContent = `${array.weight}`;
	elCandy.textContent = `${array.candy}`;
	elEgg.textContent = `${array.egg}`;
	elSpawnTime.textContent = `${array.spawn_time}`;
